...
func TestKeyStore2StoreAndGet(t *testing.T) {
	store, err := NewKeyStore2(ds.NewMapDatastore())
	if err != nil {
		t.Fatal(err)
	}
...
func TestKeyStore2ContainsPrefix(t *testing.T) {
...
func TestKeyStore2Reset(t *testing.T) {
	store, err := NewKeyStore2(ds.NewMapDatastore())
	if err != nil {
		t.Fatal(err)
	}
...
func TestKeyStore2Delete(t *testing.T) {
	store, err := NewKeyStore2(ds.NewMapDatastore())
	if err != nil {
		t.Fatal(err)
	}
