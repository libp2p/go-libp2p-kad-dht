...
func TestKeyStore3StoreAndGet(t *testing.T) {
	store, err := NewKeyStore3(ds.NewMapDatastore())
	if err != nil {
		t.Fatal(err)
	}
...
func TestKeyStore3ContainsPrefix(t *testing.T) {
...
func TestKeyStore3Reset(t *testing.T) {
	store, err := NewKeyStore3(ds.NewMapDatastore())
	if err != nil {
		t.Fatal(err)
	}
...
func TestKeyStore3Delete(t *testing.T) {
	store, err := NewKeyStore3(ds.NewMapDatastore())
	if err != nil {
		t.Fatal(err)
	}
