...
func (dht *KadDHT) PutValue(ctx context.Context, key string, value []byte, opts ...ropts.Option) (err error) {
...
func (dht *KadDHT) GetValue(ctx context.Context, key string, opts ...ropts.Option) (_ []byte, err error) {
...
func (dht *KadDHT) SearchValue(ctx context.Context, key string, opts ...ropts.Option) (<-chan []byte, error) {
	var cfg ropts.Options
	if err := cfg.Apply(opts...); err != nil {
		return nil, err
	}
...
func (dht *KadDHT) FindProviders(ctx context.Context, c cid.Cid) ([]pstore.PeerInfo, error) {
...
func (dht *KadDHT) FindProvidersAsync(ctx context.Context, key cid.Cid, count int) <-chan pstore.PeerInfo {
...
func (dht *KadDHT) findProvidersAsyncRoutine(ctx context.Context, key cid.Cid, count int, peerOut chan pstore.PeerInfo) {
...
func (dht *KadDHT) FindPeer(ctx context.Context, id peer.ID) (_ pstore.PeerInfo, err error) {
...
func (dht *KadDHT) FindPeersConnectedToPeer(ctx context.Context, id peer.ID) (<-chan *pstore.PeerInfo, error) {
